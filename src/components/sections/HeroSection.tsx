...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(179,85,201,0.35),_transparent_55%),radial-gradient(circle_at_bottom_left,_rgba(40,90,206,0.3),_transparent_50%)]" />
      <AmetMark className="pointer-events-none absolute -right-24 top-1/2 h-[34rem] w-[34rem] -translate-y-1/2 opacity-[0.07] sm:-right-16" />

      <div className="relative mx-auto w-full max-w-4xl px-6">
        <p className="inline-flex items-center gap-2 rounded-full border border-amet-white/15 bg-amet-white/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-amet-white/75">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          ...
          <a
            href="#quem-somos"
            className="inline-flex items-center justify-center rounded-full border border-amet-white/25 px-7 py-3.5 text-sm font-semibold text-amet-white/85 transition hover:bg-amet-white/10 hover:text-amet-white"
          >
