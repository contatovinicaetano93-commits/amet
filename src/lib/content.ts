...
export const campusContent = {
  title: "Campus e Salas",
  subtitle: "Ambiente preparado para aprender, praticar e evoluir com segurança.",
  infos: [
    {
      title: "Localização",
      description:
    ...
    },
    {
      title: "Salas de Aula",
      description:
        "Salas climatizadas, equipadas com recursos audiovisuais e layout que favorece a participação ativa.",
    },
    {
      title: "Laboratórios",
      description:
    ...
    },
    {
      title: "Atendimento",
      description:
        "Equipe disponível para orientar matrículas, estágios, pós-graduação e visitas ao campus.",
    },
  ],
};
